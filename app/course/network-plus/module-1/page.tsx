...
export default function Module1Menu() {
  const sections = [
    {
      title: "Flashcards",
      description: "Anki-style spaced repetition for terms, acronyms, and OSI models.",
      href: "/course/network-plus/module-1/flashcards",
    },
    {
      title: "Interactives",
      description: "Drag-and-drop simulators and PDU packaging labs.",
      href: "/course/network-plus/module-1/interactives",
    },
    {
      title: "Cheatsheets",
      description: "High-yield Markdown tables and port number references.",
      href: "/course/network-plus/module-1/cheatsheets",
    },
    {
      title: "Media Archives",
      description: "Custom infographics, diagrams, and video explanations.",
      href: "/course/network-plus/module-1/media",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white font-mono p-6 md:p-12 lg:p-16 max-w-5xl mx-auto flex flex-col justify-between select-none">
      ...
      <div>
        ...
        {/* List Section (White by default -> Green on hover) */}
