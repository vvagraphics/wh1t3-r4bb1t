...
export default function Module4Menu() {
  const sections = [
    {
      title: "Flashcards",
      description: "Test recall on Cat standards, fiber cores, and T568A/B color codes.",
      href: "/course/network-plus/module-4/flashcards",
    },
    {
      title: "Interactives",
      description: "T568A/B wiring simulators, cable testing, and PoE budget calculators.",
      href: "/course/network-plus/module-4/interactives",
    },
    {
      title: "Cheatsheets",
      description: "Quick reference for cable speeds, distances, and PoE wattages.",
      href: "/course/network-plus/module-4/cheatsheets",
    },
    {
      title: "Media Archives",
      description: "Video breakdowns on physical media and data center facility standards.",
      href: "/course/network-plus/module-4/media",
    },
  ];
